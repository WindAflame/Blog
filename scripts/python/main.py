...
def __search_and_replace_by_url(wrapper: IGDBWrapper, name: str, id: str | list[str]):
    requests_id = id
...
def main():
    ...
    game_json_object = __retrieve_game_information(wrapper, game_id)[0]
    # for key in ['artworks', 'videos', 'websites']:
    #     game_json_object[key] = __search_and_replace_by_url(wrapper, key, game_json_object[key])
    game_json_object['artworks'] = __search_and_replace_by_url(wrapper, 'artworks', game_json_object['artworks'])
    game_json_object['videos'] = __search_and_replace_by_url_for_videos(wrapper, game_json_object['videos'])
    # game_json_object['websites'] = __search_and_replace_by_url_for_websites(wrapper, game_json_object['websites'])
